      ...
      axios
        ...
        .then((response) => {
          setRecipe({
            ...
            ingredients: response.data.ingredients.join(','),  // Join array to display as comma-separated
            steps: response.data.steps.join(','),  // Join array to display as comma-separated
          });
        })
        .catch((error) => {
