...
const EditRecipe = () => {
            ...
            axios
                ...
                .then((response) => {
                    setRecipe({
                        ...
                        ingredients: response.data.ingredients.join(','),  // Convert array to string for editing
                        steps: response.data.steps.join(','),  // Convert array to string for editing
                    });
                })
                .catch((error) => {
    ...
    const handleSubmit = (e) => {
        ...
        const updatedRecipe = {
            ...recipe,
            ingredients: recipe.ingredients.split(','), // Convert the comma-separated string back to array
            steps: recipe.steps.split(','), // Convert the comma-separated string back to array
        };
